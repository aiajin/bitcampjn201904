-- [과제] 단일행 함수, 집합함수 문제 ( 문제 추가 )

-- 16. SUBSTR 함수를 사용하여 사원들의 입사한 년도와 입사한 달만 출력하시오.
-- substr(문자열, 자리위치, 문자의개수)
select substr(hiredate, 1,5) as "입사년과월"
from emp
;
...
-- 28. 직급별 
--     사원의 최저 급여를 출력하시오. 
--     관리자를 알 수 없는 사원의 최저 급여가 2000 미만인 그룹은 제외시키고 결과를 
--     급여에 대한 내림차순으로 정렬하여 출력하시오.
...
-- 30. 각 부서에 대해 --> e.deptno, d.deptno, dname
